...
<div className={styles.card}>
  <div className={styles.profile}>
    <img
      ...
      src={deborahPavanelli}
      alt="Déborah Pavanelli"
    />
  ...
  <div className={styles.testimonials}>
    <p className={styles.testimonial}>
      Acabei de adotar dois cachorros, e isso tem sido uma das melhores
      decisões da minha vida! São o Tisco e o Beto, e desde o momento em
      que eles chegaram em casa, trouxe tanta alegria e amor. Ver a
      felicidade nos olhos deles ao correr pelo quintal ou se aconchegar no
      sofá é simplesmente indescritível.
    </p>
    <p className={styles.testimonial}>
      Tudo isso só foi possível graças ao FindingPet. O site tornou o
      processo de adoção super simples e acessível. Além de ter uma
      interface amigável, eles cuidam de cada detalhe para garantir que os
      animais encontrem lares amorosos. Foi incrível ver como eles se
      importam com cada pet e com cada pessoa que busca adotar.
    </p>
    <p className={styles.testimonial}>
      Se você está pensando em ter um animal de estimação, recomendo
      fortemente que visite o FindingPet. Além de ganhar um novo amigo, você
      estará dando uma nova chance a um animal que precisa. Tisco e Beto
      mudaram minha vida de uma forma tão positiva, e tenho certeza de que,
      com a ajuda do FindingPet, você também pode viver essa experiência
      maravilhosa!
    </p>
  </div>
